    ...
    if (notesObj[5] == 1) {
        notesObj.forEach(function(element, index) {
            if (index % 8 == 0 && notesObj[index + 3] == 1) {
                ...
                html += `<br><div class="box" id="${index}" onclick=inside(${index})>
                <div class="delete" id="${index}" onclick=deleted(${index})>
                <button class="btn-delete"><l><span class="glyphicon glyphicon-remove remove "></span></l></button>
                </div>
